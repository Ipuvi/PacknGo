...
<body class="animsition">
  ...
  <option>Iskcon Temple</option>
	...
	<!-- Title Page -->
	<section class="bg-title-page flex-c-m p-t-160 p-b-80 p-l-15 p-r-15" style="background-image: url(images/Contact-Us1.jpg);">
	...
	<section class="section-contact bg1-pattern p-t-90 p-b-113">
		...
		<div class="container">
			...
			<form class="wrap-form-reservation size22 m-l-r-auto">
				...
				<div class="wrap-btn-booking flex-c-m m-t-13" style="margin-bottom: 50px;">
					<!-- Button3 -->
			...
			<!-- Map -->
		<div class="container">
			<div class="map bo0 bo-rad-10 of-hidden">
			<div class="row">
			<div class="col-md-3"></div>
				<div class="col-md-8"><img src="images/icon-position-map.png" style="align-items: center;"></div>
