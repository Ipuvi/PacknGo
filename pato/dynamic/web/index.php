...
<body>
    ...
    <div class="main">
								...
								<div class="resp-tabs-container">
												...
												<div class="transaction">
													<div class="tab-form-left user-form">
														<h5>EXPIRATION</h5>
															<ul>
																<li>
																	<input type="number" class="text_box" type="text" value="6" min="1" max="12" />	
																</li>
																<li>
																	<input type="number" class="text_box" type="text" value="2018" min="2018" />	
																</li>
													...
													<div class="tab-form-right user-form-rt">
														<h5>CVV NUMBER</h5>													
														<input type="text" value="xxx" onfocus="this.value = '';" onblur="if (this.value == '') g{this.value = 'xxx';}" required="required">
													</div>
													<div class="clear"></div>
												</div>
                                                <div class="single-bottom">
													<ul>
														<li>
															...
															<label for="brand"><span></span> I agree to the Terms & Conditions & Privacy Policy.</label>
														</li>
													</ul>
                                                    <br>
											</div>
                                    ...
                                    function func()
                                        {
                                            ...
                                            QRcode::png("11612138","Pic4.png");
                                             ?>
                                           window.alert("You have Successfully Booked the Ticket");
									...
									<div class="tab-1 resp-tab-content" aria-labelledby="tab_item-1">
										<div class="payment-info">
											...
											<a href="https://retail.onlinesbi.com/retail/login.htm">Continue</a>
										</div>
									</div>
		...
		<p class="footer">Copyright © 2018 Payment Form Widget. All Rights Reserved To<a href ="#"> PacknGo Tourism</a></p>
	</div>
</body>
</html>